...
import { Accordion, CollapceButton, Items } from './components';

export const Category: FC<SectionProps> = ({
    searchedValue,
    category,
    onItemClick,
    onMoreClick,
    ...
    const shownItems = isMoreItemsAvailable
        ? list.slice(0, DEFAULT_LIST_ITEMS_TO_SHOW_QTY)
        : list;
        ...
        <div className={styles.category}>
            <div className={styles.titleWrapper}>
                <h4 className={styles.title}>
                    {CATEGORY_NAMES_RESOLVER[categoryName]}
                </h4>
